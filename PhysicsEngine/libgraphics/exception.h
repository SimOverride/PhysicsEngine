...
/*
 * Function: PERaiseException
 * Usage: PERaiseException(&e, name, value);
 * ---------------------------------------
...
void PERaiseException(exception *e, string name, void *value);
...
#define raise(e) PERaiseException(&e, #e, NULL)
